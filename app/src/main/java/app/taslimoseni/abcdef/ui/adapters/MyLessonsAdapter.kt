...
import app.taslimoseni.abcdef.databinding.LessonItemBinding
...
class MyLessonsAdapter(var context: Context) : ListAdapter<Lesson, MyLessonsAdapter.ViewHolder>(LessonDiffCallback()) {
